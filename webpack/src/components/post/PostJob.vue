    ...
    <div class="" v-if="!isEdit">
      ...
      <div class="row actions-row">
        <div class="col-xs-12 col-sm-6">
          <div class="box">
            <input type="submit" name="name" value="Edit" class="btn btn-blue" v-on:click="isEdit= true">
          </div>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="box">
            <input type="submit" name="name" value="Submit" class="btn btn-green" v-on:click="saveJob">
          </div>
        </div>
      </div>
    </div>
